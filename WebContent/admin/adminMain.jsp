...
/* 회원 명단 style */
.memberList{position:absolute; top:120px; left:400px;} 
...
<ul class="list-group">
  <li class="list-group-item">
  	<a href="${pageContext.request.contextPath}/memberList.admin?cpage=1" class="list-group-item list-group-item-action list-group-item-secondary admin_menu">회원 명단</a>
  </li>
  <li class="list-group-item">
